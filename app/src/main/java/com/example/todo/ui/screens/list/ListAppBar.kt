...
import com.example.todo.util.states.TrailingIconState
        ...
        SearchAppBarState.CLOSED -> {
            ...
            SearchAppBar(
                ...
                onTextChange = { newText ->
                    ...
                    sharedViewModel.searchDatabase(searchQuery = newText)
                },
                onCloseClicked = {
                    sharedViewModel.searchAppBarState.value =
                        SearchAppBarState.CLOSED
...
fun DefaultListAppBar(
    ...
    TopAppBar(
        title = {
            Text(
                text = stringResource(id = com.example.todo.R.string.tasks),
                    ...
                    onClick = {
                        when (trailingIconState) {
                            TrailingIconState.READY_TO_DELETE -> {
                                trailingIconState = if(text.isNotEmpty()){
                                    onTextChange("")
